...
class _ForgotPasswordResetPageState extends State<ForgotPasswordResetPage> {
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      await PasswordResetService.verifyOtpAndResetPassword(
      ...
      AppToast.showSuccess(context, 'Password berhasil diubah. Silakan login lagi.');
      context.go('/login');
    } catch (e) {
      if (!mounted) return;
      AppToast.showError(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Masukkan password baru lalu konfirmasi sekali lagi.',
                        style: GoogleFonts.poppins(
